...
class LawNerProcessor(DataProcessor):
    """Processor for the chinese ner data set."""
    ...
    def get_labels(self):
        """See base class."T", "N", "D", 'K', 'P', 'R'"""
        return ["X", 'B-T', 'B-N', 'B-D', 'B-K', 'B-P', 'B-R',
                'I-T', 'I-N', 'I-D', 'I-K', 'I-P', 'I-R',
                'O', 'S-T', 'S-N', 'S-D', 'S-K', 'S-P', 'S-R', "[START]", "[END]"]
...
class KeywordNerProcessor(DataProcessor):
    """Processor for the chinese ner data set."""
...
ner_processors = {
    ...
    "lawner": LawNerProcessor,
    'keyword': KeywordNerProcessor,
}
